...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/jnurlguoyzudn3jfygcr9r628j9xej441wkadozcj6n2835y/tinymce/6/tinymce.min.js"
...
<body class="g-sidenav-show   bg-gray-100">
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            made with <span style="font-size: 40px">🤯</span> by DISKOMINFO Dev Team
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="card shadow-lg">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Ganti Tema</h5>
                    <p>Rubah mode gelap atau terang</p>
                </div>
    ...
    <script>
        tinymce.init({
            ...
            tinycomments_author: 'Admin Apeksi',
        });
    </script>
    <!-- Github buttons -->
