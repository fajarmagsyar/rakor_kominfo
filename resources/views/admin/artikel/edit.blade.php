                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/admin/artikel/{{ $data->artikel_id }}" class="parsley-examples"
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    <label for="id_rayon" class="form-label">Nama <span class="text-danger">*</span></label>

                                    <select class="form-select" value="{{ $data['user_id'] }}" aria-label="user_id"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea placeholder="Masukan isi" name="isi" value="{{ old('isi') }}"
                                        class="summernote @error('isi') is-invalid @enderror" id="">{{ old('isi', $data->isi) }}</textarea>
                                    @error('isi')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="link" parsley-trigger="change" required
                                        value="{{ $data->link }}"
                                        class="form-control @error('link') is-invalid @enderror" id="userName"
